(function() {
            ...
            if (resultado.tipo === 'exito') {
                Swal.fire({
                    ...
                    customClass: {
                        popup: 'swal-popup-lg',
                        title: 'swal-title-lg',
                        confirmButton: 'swal-button-lg',
                        cancelButton: 'swal-button-lg'
                    }
                });
    ...
    function confirmarEliminarTarea(tarea) {
        Swal.fire({
            title: '¿Estás seguro?',
            text: `Esta acción eliminará la tarea "${tarea.nombre}" y no se puede deshacer.`,
            icon: 'warning',
        ...
        try {
            ...
            if(resultado.resultado) {
                Swal.fire({
                    ...
                    text: resultado.resultado.mensaje,
                    timer: 2000,
                    showConfirmButton: false,
                    width: '400px',
                    padding: '2rem',
